...
class Sub_CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $sub_categories=[  
            //paddy
            [ "name" => "চান্দিনা", 'category_id' => 1],
            [ "name" => "চান্দিনা", 'category_id' => 3],
            [ "name" => "মালা", 'category_id' => 1],
            [ "name" => "মালা", 'category_id' => 3],
            [ "name" => "বিপ্লব", 'category_id' => 2],
            [ "name" => "বিপ্লব", 'category_id' => 2],
            [ "name" => "বিপ্লব", 'category_id' => 3],
            [ "name" => "দুলাভোগ", 'category_id' => 2],
            [ "name" => "ব্রিশাইল", 'category_id' => 2],
            [ "name" => "ব্রি বালাম", 'category_id' => 3],
            [ "name" => "ব্রি বালাম", 'category_id' => 1],
            [ "name" => "শাহী বালাম", 'category_id' => 3],
            [ "name" => "নয়া পাজাম", 'category_id' => 1],
            //rice
