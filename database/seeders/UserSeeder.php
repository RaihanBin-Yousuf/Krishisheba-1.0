...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $all_users=[
            ...
            [ "name" => "ROBIN", "email" => "robin12@gmail.com", "mobile" => "01816064618","nid" => "5106894769","birth_date" => "12-11-2017","role" => "admin","address" => "chattogram","password" =>  bcrypt('12121212'),"profile_img"=>"team-3.jpg", "lat"=>22.359761, "lng"=>91.8555076],
            [ "name" => "ABISHEK", "email" => "abishek12@gmail.com", "mobile" => "01816064619","nid" => "345775445756","birth_date" => "11-10-2010","role" => "admin","address" => "chattogram","password" =>  bcrypt('12121212'),"profile_img"=>"team-4.jpg", "lat"=>22.3606898, "lng"=>91.8571316],
