...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $all_users=[
            ...
            [ "name" => "EMTIYAZ", "email" => "emtiyaz12@gmail.com", "mobile" => "01816064617","nid" => "345677544567","birth_date" => "10-11-2019","role" => "seller","password" =>  bcrypt('12121212'),"lat" => "22.351474","lng" => "91.834705"],
