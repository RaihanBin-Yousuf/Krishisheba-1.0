<section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url({{ asset('frontend-asset/home_page/img/slide/FarmarCopy_1.jpg') }})">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">স্বাগতম  <span>কৃষিসেবায়</span></h2>
              ...
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto"> আরও পড়ুন</a>
            </div>
          </div>
        </div>
  
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url({{ asset('frontend-asset/home_page/img/slide/Farmar_2.jpg') }}">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">স্বাগতম  <span>কৃষিসেবায়</span></h2>
        ...
        <!-- Slide 3 -->
       <div class="carousel-item" style="background-image: url({{ asset('frontend-asset/home_page/img/slide/Farmar_3.jpg') }}">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">স্বাগতম  <span>কৃষিসেবায়</span></h2>
              <!-- <p class="animate__animated animate__fadeInUp">প্রযুক্তির উন্নয়নে বিশ্ব যখন এগিয়ে চলছে তার নিজের অদম্য গতিতে , সেই গতিতে পিছিয়ে নেই  আমাদের কৃষিখাত। আধুনিকতার ছোয়ায় আমাদের কৃষকরা আগে থেকে সহজ পথ বেছে নিচ্ছে এবং সফল ও হচ্ছে পুরোদমে।</p> -->
