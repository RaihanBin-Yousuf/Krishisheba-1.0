...
if (document.getElementById('react_fronend_top_slider')) {
    ReactDOM.render(<TopCategorySlider />, document.getElementById('react_fronend_top_slider'));
}