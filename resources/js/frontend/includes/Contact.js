                            ...
                            <div className="col-lg-5 d-flex align-items-stretch">
                                <div className="info">
                                    ...
                                    <div className="email">
                                        ...
                                        <h4>ইমেল:</h4>
                                        <p>krishisheva@gmail.com</p>
                                    </div>
                                
                                    <div className="phone">
                                        <i className="icofont-phone"></i>
                                        <h4>যোগাযোগের নাম্বার:</h4>
                                        <p>+8801*********</p>
                                    </div>
                            ...
                            <div className="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="tel" className="form-control" name="phone" id="email" data-rule="email" data-msg="Please enter a valid email" />
                                        <div className="validate"></div>
                                    </div>
                                </div>
